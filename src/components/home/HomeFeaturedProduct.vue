<template>
  <div class="featured-product" id="home-featured-product">
      <div class="container">
        <div class="row">
          <div class="col-sm-12">
            <div class="">
              <h1>
                <span class="t-color-1">Featured</span> Products <small
        ...
        <div id="carousel-example-generic" class="carousel slide"
          ...
          <ol class="carousel-indicators">
            ...
            <li data-target="#carousel-example-generic" data-slide-to="1"><i
              ...
              <div class="row">
                <div class="col-sm-3">
                  <div class="thumbnail">
                    ...
                    <span class="service-link text-center"> <img
                      class="img-responsive" src="/assets/images/f-pro-1.jpg"
                      alt="">
