						...
						<div class="row">
							<div class="col-sm-7">
								<div class="intro-content">
									<h1>Last Chance</h1>
									<h2>
										Biggest <span class="highlight">Sale</span>
									</h2>
									<p>Nam apeirian assentior ei, utquo eros posse verterem.
										Cum eu error congue saperet. Teer eam exerci vputate
										consetetur.</p>
									<a class="btn btn-default">Shop Now</a>
								</div>
							</div>
							<div class="col-sm-5">
								<img class="img-responsive" src="/assets/images/person.png"
									height="742" alt="" />
							</div>
						</div>
					</div>
				...
				<div class="item">
					<div class="container">
						<div class="row">
							...
							<div class="col-sm-5">
								<img class="img-responsive" src="/assets/images/option.png"
									alt="" />
							</div>
						</div>
					</div>
