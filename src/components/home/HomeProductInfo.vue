<template>
  <div class="container" id="home-product-info">
		<div class="row">
			<div class="col-sm-4">
				<h1>
					<span class="t-color-3">New</span> Arrival
				</h1>
			...
			<div class="col-sm-4">
				<h1>
					<span class="t-color-4">Special</span> Product
				</h1>
			...
			<div class="col-sm-4">
				<h1>
					<span class="t-color-5">Top</span> Rated
				</h1>
